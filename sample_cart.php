...
<tbody>";
        ...
        ?>
                <tr>
                   ...
                   <td><form action="" method="POST"><input type="number" id="quantity" name="quantity[]" value="<?php echo $user_product_id ;?>" min="1" max="100" step="1" class="form-input w-50"></form></td>
...
echo $increase_quantity=updateCart();
?>
