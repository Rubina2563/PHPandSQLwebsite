...
<div class='form-outline mb-4 w-50 m-auto'>
            <select name='brand_categories' id='brand_categories' class='form-select'>
...
<div class='form-outline mb-4 w-50 m-auto'>
    ...
    <div class='form-outline mb-4 w-50 m-auto'>
        ...
        <input type='text' class='form-control' name='price' placeholder='Enter price here' id='price' autocomplete='off' required='required'>
    </div>  
    <div class='form-outline mb-4 w-50 m-auto'>
